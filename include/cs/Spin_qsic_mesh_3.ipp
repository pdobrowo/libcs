...
public:
    ...
    Spin_qsic_mesh_3(const Spin_qsic_3<Kernel_> &spinQsic);
...
private:
    const Spin_qsic_3<Kernel_>        &m_spinQsic;
...
template<class Kernel_>
Spin_qsic_mesh_3<Kernel_>::Spin_qsic_mesh_3(const Spin_qsic_3<Kernel_> &spinQsic)
    : m_spinQsic(spinQsic)
{
}
